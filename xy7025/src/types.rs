...
///
/// The two cumulative limits (`max_charge_*`, `max_energy_*`) are
/// exposed as raw low/high words. Compose with
...
pub struct GroupParams {
    ...
    pub s_ovp_v: f32,
    pub s_ocp_a: f32,
    /// Over-power threshold in W (no scale).
    pub s_opp_w: u16,
...
impl GroupParams {
    ...
    /// Compose `s_owh_low`/`s_owh_high` into watt-hours (raw / 1000).
